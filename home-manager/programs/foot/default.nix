{ config, ...}:
{
  programs.foot = {
    ...
    settings = {
      main = {
        font = "Iosevka Term:size14:weight=SemiBold";
        font-bold= "Iosevka Term:size=14:weight=Heavy";
        font-italic= "Iosevka Term:size=14:weight=Bold:slant=italic";
        font-bold-italic= "Iosevka Term:size=14:weight=Heavy:slant=italic";
